...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-memalign-hack --arch=x86 --target-os=mingw32 --cross-prefix=i686-w64-mingw32- --pkg-config=pkg-config --enable-nonfree --enable-gpl --enable-version3 --enable-libmp3lame --enable-libopus --enable-libtheora --cpu=native --enable-libnvenc
prefix=/usr/local
...
CFLAGS-ffplay=-I/home/lin/source.build/crosscompile/mxe/usr/i686-w64-mingw32/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lavicap32 -lgdi32 -lpsapi -lole32 -lstrmiids -luuid -lws2_32 -L/home/lin/source.build/crosscompile/mxe/usr/i686-w64-mingw32/lib -lmingw32 -lSDLmain -lSDL -lwinmm -mwindows -liconv -lm -luser32 -lgdi32 -lwinmm -ldxguid -ltheoraenc -ltheoradec -logg -lopus  -lmp3lame -lm -llzma -lbz2 -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
...
LIBS-ffplay=-L/home/lin/source.build/crosscompile/mxe/usr/i686-w64-mingw32/lib -lmingw32 -lSDLmain -lSDL -lwinmm -mwindows -liconv -lm -luser32 -lgdi32 -lwinmm -ldxguid
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=-lole32
!ARCH_AARCH64=yes
